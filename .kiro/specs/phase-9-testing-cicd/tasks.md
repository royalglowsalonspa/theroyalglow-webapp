...
- Provisioning secrets / Cloudflare Pages / Neon API / BetterStack monitors is deploy-time ops; workflows reference the names. k6 against a live URL and the backup/replication crons are ops-activated.
