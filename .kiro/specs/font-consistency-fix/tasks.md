...
- [ ] 3. Tier 1 (PREREQUISITE) — Add `font-ui` to shared UI primitive bases
...
- [ ] 5. Audit & fix customer route-group layout
...
- [ ] 6. Audit & fix homepage and its `_components`
...
- [ ] 7. Audit & fix About page
  - Files: `app/(customer)/about/page.tsx`
  - _Property 1: Expected Behavior; Property 2: Preservation_
  - _Requirements: 2.1, 2.2, 2.3, 2.5, 3.3_

- [ ] 8. Audit & fix Blog list and post pages
...
- [ ] 9. Audit & fix Bookings list and detail pages
...
- [ ] 10. Audit & fix Contact page and form
...
- [ ] 20. Audit & fix Services catalogue and detail pages
...
- [ ] 21. Audit & fix Auth route-group layout and onboarding
...
- [ ] 24. Audit & fix shared `layout` components
...
- [ ] 25. Audit & fix shared `booking` components
...
- [ ] 26. Audit & fix shared `blog` components
...
- [ ] 31. Audit & fix shared `notifications` component
  - Files: `components/notifications/NotificationBell.tsx`
  - Count badge/labels → `font-ui`
  - _Property 1: Expected Behavior; Property 2: Preservation_
  - _Requirements: 2.3, 2.5, 3.3_

- [ ] 32. Audit & fix shared `consent` components
...
- [ ] 33. Audit & fix shared `auth` component
...
- [ ] 34. Audit & fix shared `pwa` components
...
- [ ] 35. Audit & fix `ui` non-primitive text usages
...
- [ ] 36. Checkpoint — full verification and build gate
