 ...
 * Module Name  : GemsLayout
 * Scope        : Customer Pages — profile-completion gate
 *
 * Description  : Server layout that gates /gems on a completed
 ...
 *
 * Notes        : Mirrors the /profile, /bookings and /membership segment gates.
 ************************************************************/

import { requireOnboardedSession } from '@/lib/onboarding-guard'

export default async function GemsLayout({ children }: { children: React.ReactNode }) {
