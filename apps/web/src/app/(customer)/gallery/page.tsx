...
export const metadata: Metadata = buildMetadata({
  title: 'Gallery',
  description: 'See the Royal Glow Salon & Spa — our interiors, treatments, and work in Bengaluru.',
  path: '/gallery',
})
...
export default async function GalleryPage() {
  ...
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{ name: 'Home', url: SITE_URL }, { name: 'Gallery' }]),
          ...images.map((img) =>
            imageObjectJsonLd({
              url: img.image.url,
              alt: img.image.alt,
              ...
              ...(img.image.height !== null ? { height: img.image.height } : {}),
            }),
          ),
        ]}
      />
        ...
        <section aria-labelledby="gallery-page-heading" className="px-5">
          <div className="mx-auto max-w-[1278px] mt-6 lg:mt-10">
            ...
            <p className="font-sans text-[17px] leading-[1.6] text-warm-gray mt-4 max-w-[520px]">
              A look inside Royal Glow — our interiors, treatments, and the work our team is proud
              of.
            </p>
          </div>
        </section>
