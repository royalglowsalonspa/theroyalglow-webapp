 ...
 *                strip from the first active Payload banner within its
 *                scheduled window. Falls back to hardcoded copy when the CMS
 *                is unconfigured, unreachable, or empty.
 *
 * Responsibilities :
 * - Fetch active banners via getActiveBanners()
 * - Render headline + link from the first banner in display order
 ...
 *
 * Dependencies : @/lib/cms/client, next/link
 *
 * Notes        :
