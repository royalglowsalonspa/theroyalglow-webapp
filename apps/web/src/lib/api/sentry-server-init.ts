 ...
 * Module Name  : sentry-server-init
 ...
 *   The root instrumentation.ts in apps/web was DELETED because OpenNext's
 ...
 *                no-op without NEXT_PUBLIC_SENTRY_DSN and only enabled in
 *                production — so importing them here is safe in every
