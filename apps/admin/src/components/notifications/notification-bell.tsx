 ...
 *                polling, and mark-all-read functionality. Migrated verbatim
 *                from apps/web; same-origin against the admin's own
 ...
 * Dependencies : None
 *
 * Notes        : Renders nothing until the first authenticated fetch succeeds,
 *                so it is safe to mount before the admin notifications API is
 *                migrated.
 ************************************************************/
