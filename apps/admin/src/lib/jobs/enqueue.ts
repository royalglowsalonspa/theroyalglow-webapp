...
// QStash publish helper for the triggered jobs. The originating business event
// calls this to schedule a delayed job run.
//
...
//
// No-op + log without config and NEVER throws — enqueuing is best-effort, so
// core transactional flows (booking complete/create, membership create) never
// gain a hard dependency on QStash being live.

const logger = createLogger({
  service: 'admin:jobs:enqueue',
