...
| [better-auth-1.7.3-cleanup.md](./better-auth-1.7.3-cleanup.md) | Current Better Auth 1.7.3 cleanup, migration order, and validation |
| [better-auth-upgrade.md](./better-auth-upgrade.md) | Historical Better Auth 1.6.26 → 1.7.2 migration and rollout record |
