...
<TypeTable
  type={{
    Presentation: { type: 'apps/web/src/app, components', description: 'May import: business, db, types, errors. Must not import: nothing restricted.' },
    'API (thin)': { type: 'apps/web/src/app/api', description: 'May import: business, db, types, errors. Must not import: UI components.' },
    ...
    Types: { type: 'packages/types', description: 'May import: nothing. Must not import: everything else.' },
  }}
/>
...
<Cards>
  <Card title="Data Model" href="/docs/data-model" description="Schema conventions, enums, and ID formats" />
  <Card title="Error Handling" href="/docs/error-handling" description="The AppError class and handler pattern" />
  <Card title="API Reference" href="/docs/api-reference" description="Per-endpoint codes and contracts" />
</Cards>
