...
<Tabs items={['Core & UI', 'Data & Auth', 'Infrastructure', 'Email', 'Testing & Quality', 'Observability', 'CRM & Leads']}>
...
<Cards>
  <Card title="Architecture" href="/docs/architecture" description="How these technologies fit together as a layered monorepo" />
  <Card title="Data Model" href="/docs/data-model" description="The 38-table Drizzle schema running on Neon" />
  <Card title="System Design" href="/docs/system-design" description="High-level and low-level design documents" />
</Cards>
