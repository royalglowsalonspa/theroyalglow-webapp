...
<Tabs items={['Scheduled (former pg_cron)', 'Scheduled (HTTP)', 'Triggered']}>

<Tab value="Scheduled (former pg_cron)">
...
<Tabs items={['Booking creation', 'Booking completion', 'Membership session', 'Lead capture']}>

<Tab value="Booking creation">
...
<Cards>
  <Card title="High-Level Design" href="/docs/system-design/high-level-design" description="Architecture, decisions matrix, and NFRs" />
  <Card title="Data Model" href="/docs/data-model" description="All 38 tables, enums, and conventions" />
  <Card title="Background Jobs" href="/docs/background-jobs" description="Full job inventory and heartbeats" />
</Cards>
