...
<Info>
  **Prefer the big picture first?** Skim [Architecture](/content/docs/architecture) and
  the [Tech Stack](/content/docs/tech-stack), then come back here to run it.
</Info>
...
<Warning>
  ...
  [Environment Variables](/content/docs/environment-variables) for the full canonical list.
</Warning>
...
<Info>
  Next up: read [Conventions](/content/docs/conventions) for the coding standards every
  change is expected to follow, then the [Git Workflow](/content/docs/git-workflow) for
