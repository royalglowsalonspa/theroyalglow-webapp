...
<TypeTable
  type={{
    gst_rate: { type: 'percentage', description: 'GST rate (SAC code 999721)', default: '18%' },
    gems_earn_rate: { type: 'percentage', description: 'Gems earned per spend (1 gem per ₹100)', default: '1%' },
    gems_expiry: { type: 'days', description: 'Days after which earned gems expire', default: '365' },
    cancellation_window: { type: 'hours', description: 'Free-cancellation window before appointment', default: '4' },
    reschedule_limit: { type: 'count', description: 'Maximum reschedules per booking', default: '2' },
    noshow_approval_threshold: { type: 'count', description: 'No-shows in 90 days that trigger manager approval', default: '4' },
  }}
/>
