...
<Callout type="warn">
  **Preprod is never seeded.** It receives real (anonymized) data via nightly Neon branch reset from prod. See [Git Workflow](/docs/git-workflow) for the replication process.
</Callout>
