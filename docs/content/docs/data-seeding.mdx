...
<Warning>
  **pprd is never seeded.** It receives real (anonymized) data via nightly Neon branch reset from prod. See [Git Workflow](/content/docs/git-workflow) for the replication process.
</Warning>
