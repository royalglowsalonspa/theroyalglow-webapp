...
<Tabs items={['Customer', 'Admin Portal', 'Staff Portal', 'API', 'Background Jobs', 'Special']}>
...
<Cards>
  <Card title="Frontend" href="/docs/frontend" description="Component architecture and design system behind these pages" />
  <Card title="API Reference" href="/docs/api-reference" description="Full request/response contracts per endpoint" />
  <Card title="Background Jobs" href="/docs/background-jobs" description="Schedules and behaviour of all 19 jobs" />
</Cards>
