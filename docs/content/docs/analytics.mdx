...
<Tabs items={['PostHog', 'Microsoft Clarity']}>
<Tab value="PostHog">
...
<Tabs items={['Meta Pixel (browser)', 'Meta CAPI (server)']}>
<Tab value="Meta Pixel (browser)">
