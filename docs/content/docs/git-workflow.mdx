...
| --- | --- | --- | --- |
| `prod` | Production | `main` | Live traffic — real customers |
| `pprd` | Pre-production | `preprod` | Final validation before going live |
...
| --- | --- | --- |
| `prod` | `main` | Never reset — live customer data |
| `pprd` | `preprod` | Auto-reset daily from `main` + PII stripped |
...
1. Runs `pg_dump` against the Neon `main` branch
