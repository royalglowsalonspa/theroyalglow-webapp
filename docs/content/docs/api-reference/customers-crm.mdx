...
<TypeTable
  type={{
    q: {
      type: 'string',
      description: 'Free-text search, trimmed, max 120 chars. Matched (case-insensitive) against name, phone, and email.',
      required: false,
    },
    sort: {
      type: 'enum',
      description: 'One of ltv, visits, last_visit, name, gems, noshows.',
      required: false,
      default: 'ltv',
    },
    page: {
      type: 'number',
      description: 'Integer at least 1. Coerced from string.',
      required: false,
      default: '1',
    },
    pageSize: {
      type: 'number',
      description: 'Integer 1–100. Coerced from string.',
      required: false,
      default: '20',
    },
    tag: {
      type: 'string',
      description: 'Tag slug filter. An unknown slug matches nobody (empty result).',
      required: false,
    },
  }}
/>
...
<TypeTable
  type={{
    id: {
      type: 'string',
      description: 'Path. The customer (user) id.',
      required: true,
    },
  }}
/>
...
<TypeTable
  type={{
    noshowCount: {
      type: 'number',
      description: 'Integer at least 0. Overrides the stored no-show count.',
      required: false,
    },
    bookingRequiresApproval: {
      type: 'boolean',
      description: 'Toggles the booking-approval gate.',
      required: false,
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    bookingId: {
      type: 'string',
      description: 'Links the note to a specific booking.',
      required: false,
    },
  }}
/>
...
<TypeTable
  type={{
    tagId: {
      type: 'string',
      description: 'Non-empty id of an existing customer_tag.',
      required: true,
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    tagId: {
      type: 'string',
      description: 'Path. The tag id to unassign.',
      required: true,
    },
  }}
/>
...
<TypeTable
  type={{
    name: {
      type: 'string',
      description: 'Trimmed, 1–40 characters.',
      required: true,
    },
    color: {
      type: 'string',
      description: 'Hex colour matching #RRGGBB (six hex digits, e.g. #d4af37).',
      required: false,
    },
  }}
/>
