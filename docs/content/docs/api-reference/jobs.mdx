...
<Tabs items={['Scheduled', 'Triggered']}>
<Tab value="Scheduled">
...
<TypeTable
  type={{
    'appointment-reminders': {
      type: 'REMINDERS',
      description: 'Env var: BETTER_STACK_HEARTBEAT_REMINDERS',
    },
    'membership-expiry': {
      type: 'MEMBERSHIP_EXPIRY',
      description: 'Env var: BETTER_STACK_HEARTBEAT_MEMBERSHIP_EXPIRY',
    },
    'birthday-emails': {
      type: 'BIRTHDAY',
      description: 'Env var: BETTER_STACK_HEARTBEAT_BIRTHDAY',
    },
    'lead-followups': {
      type: 'LEAD_FOLLOWUPS',
      description: 'Env var: BETTER_STACK_HEARTBEAT_LEAD_FOLLOWUPS',
    },
    'gems-expiry-reminder': {
      type: 'GEMS_EXPIRY',
      description: 'Env var: BETTER_STACK_HEARTBEAT_GEMS_EXPIRY',
    },
    'membership-usage-nudges': {
      type: 'MEMBERSHIP_NUDGES',
      description: 'Env var: BETTER_STACK_HEARTBEAT_MEMBERSHIP_NUDGES',
    },
    'daily-sales-report': {
      type: 'NIGHTLY_SALES',
      description: 'Env var: BETTER_STACK_HEARTBEAT_NIGHTLY_SALES',
    },
    'weekly-report': {
      type: 'NIGHTLY_SALES (shared)',
      description: 'Env var: BETTER_STACK_HEARTBEAT_NIGHTLY_SALES',
    },
    'post-service-followup': {
      type: 'POST_SERVICE_FOLLOWUP',
      description: 'Env var: BETTER_STACK_HEARTBEAT_POST_SERVICE_FOLLOWUP',
    },
    'stale-booking-alert': {
      type: 'STALE_BOOKING_ALERT',
      description: 'Env var: BETTER_STACK_HEARTBEAT_STALE_BOOKING_ALERT',
    },
    'noshow-check': {
      type: 'NOSHOW_CHECK',
      description: 'Env var: BETTER_STACK_HEARTBEAT_NOSHOW_CHECK',
    },
    'membership-expired-notice': {
      type: 'MEMBERSHIP_EXPIRED_NOTICE',
      description: 'Env var: BETTER_STACK_HEARTBEAT_MEMBERSHIP_EXPIRED_NOTICE',
    },
    'nightly-sales-summary': {
      type: 'SALES_SUMMARY',
      description: 'Env var: BETTER_STACK_HEARTBEAT_SALES_SUMMARY',
    },
    'membership-auto-expire': {
      type: 'MEMBERSHIP_EXPIRE',
      description: 'Env var: BETTER_STACK_HEARTBEAT_MEMBERSHIP_EXPIRE',
    },
    'offer-auto-expire': {
      type: 'OFFER_EXPIRE',
      description: 'Env var: BETTER_STACK_HEARTBEAT_OFFER_EXPIRE',
    },
    'gems-auto-expire': {
      type: 'GEMS_EXPIRE',
      description: 'Env var: BETTER_STACK_HEARTBEAT_GEMS_EXPIRE',
    },
    'session-cleanup': {
      type: 'SESSION_CLEANUP',
      description: 'Env var: BETTER_STACK_HEARTBEAT_SESSION_CLEANUP',
    },
    'monthly-gst-summary': {
      type: 'MONTHLY_GST',
      description: 'Env var: BETTER_STACK_HEARTBEAT_MONTHLY_GST',
    },
  }}
/>
...
<Tabs items={['Scheduled (processed)', 'Reports', 'Triggered', 'stale-booking-alert', 'Failures']}>
<Tab value="Scheduled (processed)">
...
<TypeTable
  type={{
    'post-service-followup': {
      type: 'object',
      description: 'Request body: { "bookingId": "<id>" }',
    },
    'stale-booking-alert': {
      type: 'object',
      description: 'Request body: { "bookingId": "<id>" }',
    ...
    'membership-expired-notice': {
      type: 'object',
      description: 'Request body: { "membershipId": "<id>" }',
    },
    'invoice-pdf': {
      type: 'object',
      description: 'Request body: { "invoiceId": "<id>" }',
    },
  }}
/>
