...
<TypeTable
  type={{
    tier: {
      type: 'string',
      description: 'A tier id to filter by.',
      required: false,
    },
    status: {
      type: 'string',
      description: 'One of active, expired, cancelled.',
      required: false,
    },
  }}
/>
...
<TypeTable
  type={{
    customerId: {
      type: 'string',
      description: 'Non-empty user id of the customer.',
      required: true,
    },
    tierId: {
      type: 'string',
      description: 'Non-empty tier id; must resolve to an active tier.',
      required: true,
    },
    hoursMinutes: {
      type: 'integer',
      description: 'Positive. Total membership hours in minutes (Silver 480, Gold 900).',
      required: true,
    },
    pricePaise: {
      type: 'integer',
      description: 'Non-negative. GST-inclusive price in paise.',
      required: true,
    },
    startDate: {
      type: 'string',
    ...
    validityDays: {
      type: 'integer',
      description: 'Positive. Days from startDate until expiry.',
      required: true,
    },
    paymentMethod: {
      type: 'enum',
...
<TypeTable
  type={{
    id: {
      type: 'string',
      description: 'Path. The membership id.',
      required: true,
    },
  }}
/>
...
<TypeTable
  type={{
    services: {
      type: 'array',
      description: 'At least one service line (see fields below).',
      required: true,
    },
    'services[].serviceId': {
      type: 'string',
      description: 'Non-empty; must be an existing service.',
      required: true,
    },
    'services[].staffId': {
      type: 'string',
      description: 'Staff member assigned to this line.',
      required: false,
    },
    'services[].durationMinutes': {
      type: 'integer',
      description: 'Positive. Minutes to deduct for this line.',
      required: true,
    },
    bookingDate: {
      type: 'string',
...
<TypeTable
  type={{
    reason: {
      type: 'string',
      description: 'Trimmed, 1–500 characters. Appended to the membership notes as "Cancelled: {reason}".',
      required: true,
    },
  }}
/>
