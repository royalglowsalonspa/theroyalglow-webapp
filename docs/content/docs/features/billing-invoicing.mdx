...
<Info>
  ...
  membership sessions never earn gems. See [Loyalty — Gems](/content/docs/features/loyalty-gems).
</Info>
...
<Warning>
  ...
  Only marketing emails respect opt-out. See [Notifications & Email](/content/docs/features/notifications).
</Warning>
...
<Columns cols={2}>
  ...
  <Card title="SPA Memberships" href="/content/docs/features/memberships">
  The purchase and session invoices and how hours are tracked.
</Card>
  <Card title="Loyalty — Gems" href="/content/docs/features/loyalty-gems">
