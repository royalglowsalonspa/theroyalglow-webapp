...
<Accordion title="Do I need all 55 environment variables to run locally?">
...
<Accordion title="Why does the docs site use Fumadocs instead of Docusaurus or Nextra?">

Fumadocs is Next.js-native, TypeScript-first, and has a premium look out of the
box. It fits the existing stack perfectly — no context switching between
frameworks.
